...
const BalanceEditorPage = () => {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6">
      <PageHeader title="Balance Editor" />
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="rounded-lg border border-slate-700 bg-slate-800/50 px-3 py-2 text-xs text-slate-400 hover:bg-slate-700 hover:text-white transition-colors"
          type="button"
        >
          Expand All
        </button>
        ...
        {hasChanges && (
          <button
            onClick={handleReset}
            className="rounded-lg border border-red-900/50 bg-red-950/30 px-3 py-2 text-xs text-red-400 hover:bg-red-900/30 transition-colors"
            type="button"
          >
            Reset ({changedCount})
          </button>
...
export default BalanceEditorPage;
