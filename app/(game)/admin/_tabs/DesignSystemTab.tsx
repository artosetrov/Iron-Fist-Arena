...
const LoaderPreview = () => (
  <div className="h-40">
    <PageLoader icon={<GameIcon name="fights" size={32} />} text="Loading preview…" />
  </div>
);
...
const TypographyPreview = () => (
  <div className="space-y-3">
    ...
    <p className="text-sm" style={{ color: "var(--ds-text-muted)" }}>
      Body text — muted. This is how secondary information appears throughout the game UI.
    </p>
...
const NavPreview = () => (
  <div className="flex flex-col gap-2 max-w-xs">
    ...
    <div className="flex items-center gap-3 rounded-lg border border-transparent px-3 py-2.5 text-sm font-medium text-slate-400">
      <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-700/50 bg-slate-800/80">
        <GameIcon name="fights" size={20} />
      </span>
      <div>
    ...
    >
      <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-amber-700/50 bg-amber-900/30">
        <GameIcon name="admin" size={20} />
      </span>
      <div>
